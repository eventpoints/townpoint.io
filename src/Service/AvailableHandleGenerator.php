...
class AvailableHandleGenerator
{
    ...
    public function generate(int $number = 10): array
    {
        $options = [];
        for ($i = 0; $i < $number; $i++) {
            $handle = $this->generateHandle();
            $user = $this->userRepository->findOneBy(['handle' => $handle]);
